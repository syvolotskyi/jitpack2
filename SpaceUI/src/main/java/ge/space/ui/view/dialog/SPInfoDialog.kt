 ...
 * @property buttonPairs describes dialog bottom buttons
...
class SPInfoDialog : SPBaseDialog<SpInfoDialogBinding>() {
    ...
    private val buttonPairs: Array<Pair<String, String>> by nonNullArgument(KEY_BUTTONS, arrayOf())
    ...
    private fun convertDialogButtonsType() : SPDialogBottomButtonLayout.SPDialogBottomButton =
        if (isButtonsMultiple) {
            ...
            SPDialogBottomButtonLayout.SPDialogBottomButton.SPDialogBottomButtonTwice(
                createDialogButtonModel(buttonPairs[LEFT_PAIR_INDEX]),
                createDialogButtonModel(buttonPairs[RIGHT_PAIR_INDEX])
            )
        }
    ...
    private fun createDialogButtonModel(buttonPair: Pair<String, String>) =
        SPDialogBottomButtonLayout.SPDialogBottomButtonModel(
            buttonPair.first,
            SPDialogBottomVerticalButton.BottomButtonType.valueOf(buttonPair.second)
        )
    ...
    class SPInfoDialogBuilder(
        ...
        private var buttons: Array<Pair<String, String>> = arrayOf()
        ...
        fun setButtons(
            ...
            if (!isMultiple && pairs.count() < MINIMUM_TWICE_BUTTONS) {
            ...
            this.buttons = convertPairToParcelable(*pairs)
            return this
        }
        ...
        override fun build(): SPInfoDialog =
            SPInfoDialog().apply {
                arguments = bundleOf(
                    ...
                    KEY_BUTTONS to this@SPInfoDialogBuilder.buttons
                )
            }
    }
}